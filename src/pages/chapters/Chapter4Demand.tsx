...
const MCQ: McqQuestion[] = [
  ...
  { id: 'd-q6', question: 'מה ההבדל בין "תזוזה לאורך עקומת הביקוש" ל"הסטת עקומת הביקוש"?', options: ['אין הבדל אמיתי', 'תזוזה לאורך — רק כשמחיר המוצר עצמו משתנה; הסטה — כשמשתנה גורם אחר (הכנסה, תחליף, טעמים)', 'הסטה קורית רק כלפי ימין', 'תזוזה לאורך קורית רק במוצרים נורמליים'], correct: 1, explanation: 'שינוי במחיר העצמי של המוצר גורם לתנועה לאורך אותה עקומה; כל גורם אחר שאינו המחיר העצמי מזיז את העקומה כולה (הסטה).' },
  { id: 'd-q7', question: 'שני צרכנים עם ביקושים Q₁=100-2P ו-Q₂=80-P. מהי פונקציית הביקוש המצרפי (השוק) בשיטת החיבור האופקי?', options: ['Q=180-3P (חיבור נכון של Q בכל P)', 'Q=90-1.5P (ממוצע)', 'P=180-3Q', 'לא ניתן לחבר ביקושים שונים'], correct: 0, explanation: 'ביקוש שוק מחברים לפי כמות בכל מחיר נתון (חיבור אופקי): Q=(100-2P)+(80-P)=180-3P — לא לפי מחיר, ולא ממוצע.' },
  { id: 'd-q8', question: 'חמאה וללחם הם מוצרים משלימים. אם מחיר הלחם עולה משמעותית, מה קורה לביקוש לחמאה?', options: ['עולה', 'יורד — פחות צריכה של לחם מפחיתה גם את הביקוש לחמאה', 'לא משתנה בכלל', 'המחיר של חמאה יורד אוטומטית'], correct: 1, explanation: 'מוצרים משלימים נצרכים יחד — עלייה במחיר אחד (לחם) מקטינה את הצריכה שלו, וכתוצאה מכך גם את הביקוש למוצר המשלים (חמאה) — העקומה זזה שמאלה.' },
  { id: 'd-q9', question: 'בפונקציית ביקוש Q=a-bP, מה משמעות הפרמטר a (כש-P=0)?', options: ['המחיר המקסימלי שמישהו ישלם', 'הכמות המקסימלית שתידרש כאשר המוצר חינם', 'שיפוע העקומה', 'הכנסת הצרכן'], correct: 1, explanation: 'כש-P=0, Q=a — זו הכמות המקסימלית שתידרש כשהמוצר ניתן בחינם (נקודת החיתוך עם ציר הכמות).' },
]
