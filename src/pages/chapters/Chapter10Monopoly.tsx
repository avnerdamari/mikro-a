...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'mon-q6',
    question: 'מדוע ל-MR (הכנסה שולית) של מונופול תמיד יש שיפוע תלול פי-2 משיפוע עקומת הביקוש (בביקוש לינארי)?',
    options: [
      'זה מקרי בלבד',
      'כדי למכור עוד יחידה, המונופול חייב להוריד את המחיר על כל היחידות שכבר נמכרו — לא רק על היחידה הנוספת, ולכן ה-MR "נשחק" מהר יותר מהמחיר',
      'כי MC תמיד גדל פי 2',
      'זה נכון רק כשיש תחרות מושלמת'
    ],
    correct: 1,
    explanation: 'בניגוד לתחרות משוכללת (P=MR קבוע), מונופול שמוריד מחיר כדי למכור יותר מוריד אותו על *כל* היחידות שהוא כבר מוכר — לכן כל יחידה נוספת "עולה" לו יותר מבחינת הכנסה שולית, מה שגורם ל-MR לרדת מהר יותר מהביקוש עצמו (שיפוע כפול).'
  },
  {
    id: 'mon-q7',
    question: 'מדוע במונופול תמיד P* > MC (בשונה מתחרות משוכללת שבה P=MC)?',
    options: [
      'זה טעות בחישוב שאסור לעשות',
      'כי המונופול קובע כמות לפי MR=MC, אבל גובה מחיר לפי עקומת הביקוש P(Q*) שגבוהה מ-MR באותה נקודה',
      'כי MC תמיד גבוה מ-MR',
      'רק כשיש אפליית מחירים מלאה'
    ],
    correct: 1,
    explanation: 'הכמות נקבעת ב-MR=MC, אבל המחיר בפועל נקבע מעקומת הביקוש בנקודה Q* — ומכיוון שהביקוש תמיד מעל ה-MR (עקומת ביקוש יורדת), P* > MR = MC.'
  },
  {
    id: 'mon-q8',
    question: 'באפליית מחירים מדרגה ראשונה (מושלמת), מדוע ה-DWL מתאפס לגמרי, למרות שהמונופול עדיין "מנצל" את הצרכנים?',
    options: [
      'כי המונופול מייצר בדיוק את אותה כמות כמו בתחרות משוכללת — Q עולה עד לנקודה שבה נכונות-התשלום שווה ל-MC',
      'כי הצרכנים משלמים פחות מבתחרות',
      'כי הממשלה מתערבת ומונעת DWL',
      'זה לא נכון, גם באפליה מלאה יש DWL'
    ],
    correct: 0,
    explanation: 'באפליה מושלמת המונופול גובה מכל צרכן בדיוק את נכונות-התשלום שלו — ולכן ממשיך לייצר כל עוד יש צרכן שמוכן לשלם לפחות MC, בדיוק כמו בתחרות משוכללת. הכמות הכוללת זהה ל-Q_comp, כך שאין DWL — אבל כל עודף הצרכן הופך לרווח מונופול (PS), לא נעלם אלא עובר יד.'
  },
]
