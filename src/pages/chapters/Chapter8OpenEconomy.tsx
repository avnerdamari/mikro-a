...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'oe-q6',
    question: 'מדוע מדינה קטנה בכלכלה פתוחה נחשבת "price taker" (לוקחת מחיר) ביחס למחיר העולמי?',
    options: [
      'כי החוק מחייב זאת',
      'כי הכמות שהיא מייצרת/צורכת קטנה מדי ביחס לשוק העולמי כדי להשפיע על המחיר העולמי',
      'כי אין לה בכלל יצרנים מקומיים',
      'כי המחיר העולמי תמיד שווה למחיר המקומי'
    ],
    correct: 1,
    explanation: 'מדינה קטנה מהווה חלק זניח מהביקוש/היצע העולמי — לכן היא מקבלת את P_w כנתון ולא יכולה להשפיע עליו, בשונה מהשוק המקומי הסגור שבו P* נקבע ע"י D ו-S המקומיים בלבד.'
  },
  {
    id: 'oe-q7',
    question: 'מחיר עולמי P_w נמוך ממחיר שיווי המשקל המקומי P*. מה יקרה לצרכנים המקומיים?',
    options: [
      'הם ישלמו יותר וירכשו פחות',
      'הם ישלמו פחות (P_w) וירכשו יותר — עודף הצרכן שלהם עולה',
      'לא יהיה שינוי כלל',
      'הם יפסיקו לרכוש את המוצר לגמרי'
    ],
    correct: 1,
    explanation: 'כשP_w<P*, המדינה מייבאת — המחיר המקומי יורד ל-P_w, הצרכנים קונים יותר במחיר נמוך יותר, ועודף הצרכן (CS) עולה משמעותית.'
  },
  {
    id: 'oe-q8',
    question: 'לפי טבלת שעות-עבודה: פורטוגל מייצרת יין ב-80 שעות ובד ב-90 שעות; אנגליה מייצרת יין ב-120 שעות ובד ב-100 שעות. למי יתרון יחסי ביין?',
    options: [
      'לאנגליה, כי לוקח לה יותר שעות בשני המוצרים',
      'לפורטוגל — עלות ההזדמנות של יין אצלה (80/90) נמוכה מזו של אנגליה (120/100)',
      'לשתיהן באותה מידה',
      'אי אפשר לדעת בלי לדעת את המחירים'
    ],
    correct: 1,
    explanation: 'עלות ההזדמנות של יין = יחס שעות-יין לשעות-בד. פורטוגל: 80/90≈0.89. אנגליה: 120/100=1.2. לפורטוגל עלות הזדמנות נמוכה יותר ביין → יתרון יחסי, למרות שלוקח לה גם ביין וגם בבד יותר שעות בפועל (יתרון מוחלט אינו רלוונטי לקביעת דפוס הסחר).'
  },
]
