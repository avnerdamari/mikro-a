...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'eq-q6',
    question: 'מהו בדיוק תנאי שיווי המשקל בשוק תחרותי?',
    options: [
      'המחיר גבוה ככל האפשר',
      'הכמות המבוקשת שווה לכמות המסופקת באותו מחיר (D=S)',
      'כל הצרכנים מרוצים לגמרי',
      'העלות הממוצעת שווה לאפס',
    ],
    correct: 1,
    explanation: 'שיווי משקל מוגדר כמחיר P* שבו הכמות שהצרכנים רוצים לקנות שווה בדיוק לכמות שהיצרנים רוצים למכור — Q_D(P*)=Q_S(P*). זה לא קשור לשביעות-רצון או לרמת המחיר עצמה.',
  },
  {
    id: 'eq-q7',
    question: 'בפתרון תרגיל עם שתי קבוצות צרכנים (D₁ ו-D₂), מדוע חייבים להציב את P* בחזרה בכל אחת מפונקציות הביקוש בנפרד, ולא רק לחלק את Q* לשניים?',
    options: [
      'כי זה שווה בכל מקרה',
      'כי לכל קבוצה יש פונקציית ביקוש שונה (a ו-b שונים) — הכמות שכל קבוצה בפועל קונה תלויה בפרמטרים שלה, לא בחלוקה שווה',
      'כי P* משתנה בין הקבוצות',
      'זה לא נדרש, אפשר לדלג על השלב הזה',
    ],
    correct: 1,
    explanation: 'כל קבוצה עשויה להגיב אחרת לאותו מחיר P* (שיפועים/קבועים שונים בפונקציית הביקוש שלה) — לכן מציבים P* בנפרד בכל D_i כדי לקבל את Q_i האמיתי של אותה קבוצה, לא מניחים חלוקה שווה.',
  },
  {
    id: 'eq-q8',
    question: 'עודף יצרן (PS) מייצג בגרף את השטח:',
    options: [
      'מעל עקומת ההיצע ומתחת ל-P*',
      'מתחת לעקומת ההיצע ומעל P_min',
      'מעל P* ומתחת לעקומת הביקוש',
      'כל השטח מתחת לעקומת ההיצע',
    ],
    correct: 0,
    explanation: 'עודף יצרן הוא ההפרש בין מה שהיצרנים קיבלו בפועל (P*) לבין המחיר המינימלי שהיו מוכנים לקבל (עקומת ההיצע) — השטח מעל עקומת ההיצע ומתחת ל-P*.',
  },
  {
    id: 'eq-q9',
    question: 'ביקוש יורד (D זזה שמאלה) וההיצע עולה (S זזה ימינה) בו-זמנית. מה בוודאות קורה ל-Q* ול-P*?',
    options: [
      'Q* עולה בוודאי; P* לא ניתן לקביעה בלי נתוני גמישות',
      'P* עולה בוודאי; Q* לא ניתן לקביעה',
      'שניהם עולים בוודאי',
      'שניהם יורדים בוודאי',
    ],
    correct: 0,
    explanation: '↓D מוריד גם P* וגם Q*; ↑S מוריד P* אבל מעלה Q*. שני הכוחות דוחפים את P* מטה — הוא יורד בוודאי. אבל על Q* הם פועלים בכיוונים מנוגדים — הכיוון הסופי תלוי בגודל היחסי (גמישויות) של השינויים.',
  },
]
