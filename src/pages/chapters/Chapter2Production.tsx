...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'prod-q6', question: 'כאשר MP > AP (התפוקה השולית גבוהה מהממוצעת), מה קורה ל-AP כשמוסיפים עוד עובד?',
    options: ['AP יורד', 'AP עולה', 'AP לא משתנה', 'תלוי אך ורק ב-TP'],
    correct: 1,
    explanation: 'כל עוד התוספת השולית (MP) גבוהה מהממוצע הקיים (AP), התוספת "מושכת" את הממוצע כלפי מעלה — AP עולה. ברגע ש-MP<AP, ה-AP מתחיל לרדת.',
  },
  {
    id: 'prod-q7', question: 'מתי בדיוק שכר מינימום גורם לאבטלה בשוק העבודה?',
    options: [
      'תמיד, בכל רמה של שכר מינימום',
      'רק כאשר שכר המינימום נקבע מעל שכר שיווי המשקל בשוק',
      'רק כאשר שכר המינימום נקבע מתחת לשכר שיווי המשקל',
      'שכר מינימום אף פעם לא משפיע על התעסוקה',
    ],
    correct: 1,
    explanation: 'אם שכר המינימום נמוך משכר שיווי המשקל, הוא לא מגביל דבר בפועל. רק כשהוא נקבע מעל שכר השוק הוא "חוסם" חלק מהעובדים שה-VMP שלהם נמוך משכר המינימום — וגורם לאבטלה.',
  },
  {
    id: 'prod-q8', question: 'הרווח (π) של פירמה מחושב לפי:',
    options: ['π = P × TP בלבד', 'π = TR − TC = P×TP − L×W', 'π = VMP − W', 'π = TP − L'],
    correct: 1,
    explanation: 'הרווח הוא ההכנסה הכוללת (TR = P×TP) פחות העלות הכוללת (TC = L×W בפונקציית ייצור עם עבודה בלבד) — לא רק אחד מהם לבד.',
  },
  {
    id: 'prod-q9', question: 'מדוע כלל ההעסקה האופטימלי הוא בדיוק VMP=W בשוליים (העובד האחרון שמעסיקים), ולא VMP>W בהרבה?',
    options: [
      'כי החוק מחייב זאת',
      'כי כל עוד VMP>W העובד הנוסף עדיין מוסיף לרווח — ממשיכים להעסיק עד שהתוספת מתאפסת בדיוק ב-VMP=W',
      'כי VMP תמיד שווה ל-W מלכתחילה',
      'זה לא נכון — תמיד עדיף להעסיק כמה שפחות עובדים',
    ],
    correct: 1,
    explanation: 'כל עוד VMP≥W, העובד הנוסף מוסיף (או לפחות לא גורע מ) לרווח — לכן ממשיכים להעסיק. ברגע שה-VMP של העובד הבא יורד מתחת ל-W, מפסיקים. נקודת האופטימום היא בדיוק שם שה-VMP "נוגע" ב-W.',
  },
]
