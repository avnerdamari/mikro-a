...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'cost-q6', question: 'מהי נקודת ה-"Shut-down" (סגירה), ומדוע היא נקבעת דווקא לפי מינימום AVC ולא מינימום AC?',
    options: [
      'מינימום AC, כי זו נקודת האיזון היחידה',
      'מינימום AVC — מתחת לה ההפסד מהמשך-ייצור גדול יותר מ-FC, כך שעדיף לסגור ולהפסיד רק את FC',
      'המחיר בו FC=VC',
      'נקודת ה-shut-down משתנה כל יום לפי מחיר השוק בלבד',
    ],
    correct: 1,
    explanation: 'כשP<AVC, כל יחידה שמייצרים מגדילה את ההפסד מעבר ל-FC בלבד — לכן עדיף לסגור ולהפסיד רק FC. ב-AC, ההפסד עדיין קטן מ-FC כל עוד P≥AVC, ולכן ממשיכים לייצר בטווח קצר גם כשP<AC.',
  },
  {
    id: 'cost-q7', question: 'כלל מקסום הרווח בתחרות משוכללת הוא MC=P. מדוע יצרן לא ירצה לייצר יחידה נוספת כש-MC>P?',
    options: [
      'כי החוק אוסר על כך',
      'כי עלות היחידה הנוספת (MC) גבוהה מההכנסה ממנה (P) — ייצורה יקטין את הרווח',
      'כי MC תמיד שווה ל-AC',
      'כי P תמיד עולה כשMC עולה',
    ],
    correct: 1,
    explanation: 'אם MC>P, כל יחידה נוספת עולה יותר משהיא מכניסה — הרווח יורד. לכן היצרן עוצר בדיוק בנקודה שבה MC=P (או הכי קרוב אליה מלמטה).',
  },
  {
    id: 'cost-q8', question: 'למה מינימום AVC תמיד נמוך ממינימום AC, ולא ההפך?',
    options: [
      'AC = AVC + AFC (עלות קבועה ממוצעת), ו-AFC תמיד חיובית — כך ש-AC>AVC בכל כמות',
      'זה לא נכון תמיד, תלוי בנתונים',
      'AVC כולל גם עלות קבועה',
      'AC ו-AVC תמיד שווים בטווח הקצר',
    ],
    correct: 0,
    explanation: 'AC=TC/Q=(FC+VC)/Q=AFC+AVC. מכיוון ש-AFC>0 תמיד (כל עוד FC>0), AC גדול מ-AVC בכל רמת תפוקה — ולכן גם מינימום AC גבוה ממינימום AVC.',
  },
  {
    id: 'cost-q9', question: 'אם בענף פועלים 50 יצרנים זהים, וההיצע של כל יצרן בודד בכמות מסוימת הוא 20 יחידות — מהי כמות ההיצע של השוק כולו?',
    options: ['20 יחידות', '50 יחידות', '1,000 יחידות (50×20)', '70 יחידות (50+20)'],
    correct: 2,
    explanation: 'כשכל היצרנים זהים, היצע השוק הוא סכום הכמויות — כלומר מספר היצרנים כפול הכמות של יצרן בודד: 50×20=1,000.',
  },
]
