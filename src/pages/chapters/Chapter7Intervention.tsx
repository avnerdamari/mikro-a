...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'int-q6', question: 'מדוע מטילים מס תמיד גורם ל-P_c (מה שהצרכן משלם) להיות גבוה מ-P_p (מה שהיצרן מקבל בפועל)?', options: ['זו החלטה שרירותית של הממשלה', 'ההפרש בין השניים הוא בדיוק גובה המס t — הממשלה גובה אותו מהעסקה', 'P_c ו-P_p תמיד שווים', 'רק אם המס מוטל על הצרכן ולא על היצרן'], correct: 1, explanation: 'הקשר P_c=P_p+t (או P_p=P_c-t) הוא הגדרת המס עצמה — הפער בין מה ששילם הצרכן למה שקיבל היצרן, בכל יחידה, שווה בדיוק לגובה המס.' },
  {
    id: 'int-q7', question: 'ביקוש קשיח מאוד (E נמוך) לעומת יצרן עם ביקוש גמיש — מי נושא בעיקר בנטל המס?', options: ['היצרן, תמיד', 'הצרכן — ביקוש קשיח אומר שהצרכנים לא יכולים/רוצים להפחית משמעותית את הכמות כשהמחיר עולה', 'שני הצדדים תמיד חולקים בדיוק חצי-חצי', 'הממשלה סופגת את ההפרש'], correct: 1, explanation: 'כשהביקוש קשיח, הצרכנים ממשיכים לקנות כמעט אותה כמות גם כשהמחיר עולה — כך שקל יותר "להעביר" אליהם את רוב נטל המס. הכלל: הצד הפחות-גמיש (קשיח יותר) נושא בנטל הגדול יותר.' },
  {
    id: 'int-q8', question: 'סובסידיה של 15₪ ליחידה ניתנת ליצרן. אם P_c (מחיר לצרכן) יורד ל-90₪, כמה מקבל היצרן בפועל ליחידה (P_p)?', options: ['75₪', '90₪', '105₪', '15₪'], correct: 2, explanation: 'בסובסידיה, היצרן מקבל את מה ששילם הצרכן ועוד את הסובסידיה: P_p=P_c+sub=90+15=105₪.' },
  {
    id: 'int-q9', question: 'מחיר מקסימום (תקרת מחיר) נקבע *מעל* מחיר שיווי המשקל P*. מה תהיה ההשפעה בפועל על השוק?', options: ['ייווצר עודף ביקוש משמעותי', 'לא תהיה שום השפעה בפועל — השוק ימשיך להיסחר ב-P* הרגיל, כי המגבלה לא כובלת', 'המחיר יעלה מעבר לתקרה', 'ייווצר עודף היצע'], correct: 1, explanation: 'תקרת מחיר "כובלת" (משפיעה בפועל) רק כשהיא נמוכה מ-P*. אם היא מעל P*, השוק ממילא נסחר מתחתיה בשיווי משקל רגיל — התקרה לא מגבילה דבר.' },
]
