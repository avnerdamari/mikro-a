...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'tar-q4',
    question: `Qd=200−2P, Qs=P−40. P*=80 (D=S). P_w=60, t=30. מה קורה בפועל אחרי המכס?`,
    options: [
      'ממשיכים לייבא 40 יחידות',
      'P_w<P* מלמד שללא מכס המדינה מייבאת — אבל עם t=30, P_t=90>P*=80, כך שבפועל היצרנים המקומיים מוכרים יותר משהצרכנים קונים, והמדינה הופכת ליצואנית (30 יחידות)',
      'המכס לא משנה כלום כי P_w נשאר קבוע',
      'יבואו בדיוק 30 יחידות',
    ],
    correct: 1,
    explanation: 'תמיד קודם למצוא P* (כאן 80) כדי לדעת את כיוון הסחר הבסיסי: P_w=60<P*=80 → ללא מכס המדינה מייבאת. אבל מכס t=30 מעלה את המחיר המקומי ל-P_t=P_w+t=90, שהוא כבר מעל P*=80. ב-P_t=90: Qd=200−180=20, Qs=90−40=50 — כלומר Qs>Qd, ולכן המכס כה גבוה שהוא הפך את המדינה ליצואנית (עודף היצע של 30 יחידות), לא רק צמצם את היבוא. תמיד לבדוק היכן P_t עומד ביחס ל-P* לפני שקובעים כיוון סחר.'
  },
  {
    id: 'tar-q5',
  ...
  {
    id: 'tar-q6',
    question: 'מדוע הכנסות הממשלה ממכס (t×יבוא) *אינן* נחשבות חלק מ-DWL (אובדן היעילות)?',
    options: [
      'כי הממשלה תמיד משתמשת בכסף הזה טוב',
      'כי זו העברת-כסף מהצרכנים לממשלה, לא אובדן ערך כלכלי אמיתי — הרווחה הכוללת של המשק לא נעלמת, רק עוברת יד',
      'כי הממשלה היא חלק מהיצרנים',
      'למעשה כן נחשבת, בטעות לא נכלל בחישוב הרגיל'
    ],
    correct: 1,
    explanation: 'DWL מייצג ערך כלכלי שנעלם לגמרי (עסקאות שהיו יכולות להתבצע ביעילות ולא מתבצעות). הכנסת הממשלה היא רק העברה מהצרכנים אליה — הכסף לא נעלם מהמשק, ולכן אינה חלק מה-DWL.'
  },
  {
    id: 'tar-q7',
    question: 'מכסת יבוא (quota) של 50 יחידות ומכס שגם הוא מגביל את היבוא בפועל ל-50 יחידות — מה ההבדל המרכזי ביניהם בהיבט התקציבי?',
    options: [
      'אין הבדל, שניהם מעבירים את הרנטה לממשלה',
      'במכס הממשלה גובה הכנסה (t×יבוא); במכסה, אם הרישיונות ניתנים בחינם, ה"רנטה" (הפער בין מחיר-עם-מכסה למחיר-עולמי) נשארת אצל בעלי הרישיונות',
      'מכסה תמיד יקרה יותר לצרכן ממכס',
      'מכס אף פעם לא מכניס הכנסה לממשלה'
    ],
    correct: 1,
    explanation: 'שני הכלים יכולים לצמצם יבוא לאותה כמות ולהעלות את המחיר המקומי לאותה רמה — אבל מי "מרוויח" מהפער בין המחיר החדש למחיר העולמי שונה: בממס זו הממשלה, במכסה (ללא מכרז) אלו בעלי הרישיונות.'
  },
  {
    id: 'tar-q8',
    question: 'מכס גבוה במיוחד יכול להעלות את המחיר המקומי כל כך שהמדינה תפסיק לייבא לגמרי. מה זה שקול אליו?',
    options: [
      'מכסת יבוא של אפס יחידות (איסור יבוא בפועל)',
      'סובסידיה מלאה ליצרנים',
      'מחיר מינימום מתחת ל-P*',
      'ביטול המס לגמרי'
    ],
    correct: 0,
    explanation: 'מכס מספיק גבוה מעלה את המחיר המקומי לרמה שבה Qs≥Qd גם ללא יבוא כלל — מבחינת התוצאה בשוק, זה שקול לאיסור יבוא מוחלט (מכסה של אפס).'
  },
]
