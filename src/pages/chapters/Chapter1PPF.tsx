...
const MCQ: McqQuestion[] = [
  ...
  {
    id: 'ppf-q6', question: 'מהן שלוש שאלות היסוד שכל חברה חייבת לענות עליהן, לפי הבעיה הכלכלית הבסיסית?',
    options: [
      'כמה לחסוך? כמה להשקיע? כמה למסות?',
      'מה לייצר? איך לייצר? למי לחלק?',
      'מי המנהל? מי העובדים? מי הלקוחות?',
      'מתי לייצר? איפה לייצר? כמה לייצר?',
    ],
    correct: 1,
    explanation: 'הבעיה הכלכלית הבסיסית (משאבים מוגבלים מול צרכים אינסופיים) מכריחה כל חברה להכריע מה לייצר, איך לייצר, ולמי לחלק את התוצר.',
  },
  {
    id: 'ppf-q7', question: 'מהי בדיוק "עלות אלטרנטיבית" של מוצר X, לפי ההגדרה שנלמדה?',
    options: [
      'המחיר בשקלים ששילמתם על X',
      'הכמות הטובה ביותר של מוצר אחר שוויתרתם עליה כדי לייצר/לרכוש X',
      'העלות הכוללת של כל חומרי הגלם',
      'הרווח שהפסדתם בעבר',
    ],
    correct: 1,
    explanation: 'עלות אלטרנטיבית אינה מחיר כספי — היא הוויתור הטוב ביותר (מוצר אחר) שנדרש כדי להשיג את X, ומחושבת כתפוקת-המוצר-האחר חלקי תפוקת-X לאותו עובד/משאב.',
  },
  {
    id: 'ppf-q8', question: 'איזה שינוי יגרום ל-PPF לזוז פנימה (יכולת הייצור הכוללת יורדת)?',
    options: ['עלייה לארץ', 'שיפור טכנולוגי', 'מלחמה שהורסת ציוד ייצור', 'גילוי משאב טבע חדש'],
    correct: 2,
    explanation: 'PPF זזה פנימה כשכמות/איכות המשאבים בפועל יורדת — מלחמה שהורסת ציוד היא דוגמה קלאסית. שאר האפשרויות מגדילות את היכולת ומזיזות את ה-PPF החוצה.',
  },
  {
    id: 'ppf-q9', question: 'מהו ההבדל בין "יתרון יחסי" ל"יתרון מוחלט" בהקשר של PPF?',
    options: [
      'אין הבדל, אלה שני שמות לאותו מושג',
      'יתרון מוחלט = מייצרים יותר בכמות מוחלטת; יתרון יחסי = עלות אלטרנטיבית נמוכה יותר — וזה מה שקובע התמחות',
      'יתרון יחסי רלוונטי רק למדינות, לא לעובדים בודדים',
      'יתרון מוחלט תמיד גובר על יתרון יחסי בהחלטת ייצור',
    ],
    correct: 1,
    explanation: 'ייתכן שגורם אחד עדיף בייצור שני המוצרים בכמות מוחלטת (יתרון מוחלט), אך ההתמחות היעילה נקבעת לפי מי שיש לו עלות אלטרנטיבית נמוכה יותר (יתרון יחסי) — לא לפי היקף הייצור הגולמי.',
  },
  {
    id: 'ppf-q10', question: 'שני עובדים מייצרים כל אחד 0.5 ריאלטי או 2 גרעינים לשעה (אותה טכנולוגיה). מה ניתן להסיק על היתרון היחסי ביניהם?',
    options: [
      'לאחד מהם בהכרח יתרון יחסי בריאלטי',
      'אין יתרון יחסי לאף אחד — העלות האלטרנטיבית זהה, אין בסיס להתמחות ביניהם',
      'שניהם צריכים להתמחות בגרעינים',
      'אי אפשר לדעת בלי לדעת את המחירים בשוק',
    ],
    correct: 1,
    explanation: 'יתרון יחסי נובע מהבדל בעלות אלטרנטיבית בין הגורמים. כששני העובדים בעלי אותה טכנולוגיה בדיוק, העלות האלטרנטיבית זהה, ואין בסיס-כלכלי להתמחות ביניהם (בשונה משאלה על מחירי-שוק, שקובעת מה כדאי לייצר בפועל, לא מי בעל יתרון יחסי).',
  },
]
