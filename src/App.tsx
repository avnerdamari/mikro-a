...
function AppContent() {
  ...
  const renderChapter = () => {
    switch (currentChapter) {
      case 'intro':        return <ChapterIntro />
  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      {/* כפתורים צפים — שמאל-תחתון, טור אנכי (סקיל build-book, סעיף 2א).
          data-floating-stack: נמדד ע"י MindMapPanel כדי למקם את הריבוע
      ...
      {!isHome && !floatingButtonsHidden && (
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex w-36 items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-bold text-white shadow-lg transition hover:shadow-xl active:scale-95 active:translate-y-0.5 active:shadow-md"
      ...
      {!isHome && mindMapOpen && (
        <MindMapPanel
          onNavigate={(id) => { setCurrentChapter(id); }}
